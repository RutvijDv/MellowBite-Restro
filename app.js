...
const db = mongoose.connect(process.env.CONNECTIONSTRING, {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});
...
app.get("/addmenu", function (req, res) {
  if (
    (req.isAuthenticated() && req.user.username == "rutvij.vamja@gmail.com") ||
    req.user.username == "shrushtivasaniya@gmail.com"
  ) {
    res.render("addmenu");
  } else {
    res.redirect("/main");
